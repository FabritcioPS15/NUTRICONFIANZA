    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f2f4f1] to-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[#8aaa1f] rounded-3xl mb-4 shadow-lg shadow-[#8aaa1f]/20">
          ...
          <div className="relative">
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-500 text-sm font-medium">
                ¿Ya tienes cuenta?{' '}
                <Link to="/login" className="text-[#477d1e] font-black hover:underline">
                  Inicia sesión
                </Link>
              </p>
            </div>
