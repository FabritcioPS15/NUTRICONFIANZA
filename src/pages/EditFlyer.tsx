...
export function EditFlyer() {
  ...
  const handleSave = async () => {
    console.log('Guardando flyer:', { id, title, authorName, category, mediaUrl });
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white border border-gray-100 rounded-[3rem] p-8 shadow-sm">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-black text-[#1a1a1a]">Editar Flyer</h1>
              <p className="text-gray-500">Modifica la información del flyer</p>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-2xl p-8 text-center hover:border-[#246b38] transition-colors">
                <input
                  ...
                  className="hidden"
                  id="thumbnail-upload-flyer"
                />
                <label htmlFor="thumbnail-upload-flyer" className="cursor-pointer">
