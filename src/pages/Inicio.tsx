    ...
    <div className="flex flex-col gap-16 md:gap-32 py-10 md:py-20">
      ...
      <section className="flex flex-col md:flex-row items-center gap-12 animate-fade-in-up">
        <div className="flex-1 space-y-6 md:space-y-10 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
            <button className="w-full sm:w-auto bg-[#246b38] hover:bg-[#1a4d2e] text-white px-10 py-5 rounded-2xl font-bold transition-all flex items-center justify-center gap-3 shadow-xl shadow-[#246b38]/20 hover:scale-105 active:scale-95">
        ...
        <div className="flex-1 relative w-full md:w-auto">
          ...
          <div className="absolute -bottom-6 left-1/2 -ms-28 md:ms-0 md:left-4 bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-6 flex items-center gap-5 border border-white/20 w-56 md:w-auto">
            <div className="bg-[#246b38] rounded-xl p-3 flex items-center justify-center shadow-lg shadow-[#246b38]/20">
      ...
      <section className="space-y-12">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 text-center md:text-left">
           ...
           <Link to="/videos" className="text-[#246b38] font-bold flex items-center gap-2 hover:gap-4 transition-all group">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Link to="/videos" className="p-10 rounded-[3rem] bg-white border border-gray-100 shadow-sm hover:shadow-2xl transition-all group relative overflow-hidden">
            ...
            <div className="flex items-center gap-2 text-[#246b38] font-black text-[10px] uppercase tracking-widest">
          ...
          <Link to="/comunidad" className="p-10 rounded-[3rem] bg-[#1a4d2e] shadow-xl hover:shadow-2xl transition-all group relative overflow-hidden text-white">
      ...
      <section className="relative overflow-hidden bg-[#1a1a1a] rounded-[4rem] p-10 md:p-20 text-white group">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[#246b38]/20 blur-[100px] -z-0 pointer-events-none" />
        <div className="flex flex-col md:flex-row items-center gap-16 relative z-10">
          <div className="flex-1 space-y-8 text-center md:text-left">
            <span className="text-[10px] font-black px-4 py-2 bg-[#246b38] rounded-full uppercase tracking-widest shadow-lg shadow-[#246b38]/40">
              PRÓXIMO WEBINAR
            </span>
            <h2 className="text-4xl md:text-6xl font-black leading-tight italic">
              "Mitos Alimentarios que <span className="text-[#246b38] not-italic underline decoration-white/20">Agotan tu Energía</span>"
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center justify-center md:justify-start">
               <button className="w-full sm:w-auto bg-white text-black px-10 py-5 rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-[#246b38] hover:text-white transition-all shadow-xl shadow-white/5">
          ...
          <div className="flex-1 hidden md:block">
            <div className="relative">
               <div className="w-full aspect-square rounded-[3rem] bg-[#246b38]/10 border border-white/10 flex items-center justify-center group-hover:scale-105 transition-transform duration-700">
                  <Play className="w-20 h-20 text-[#246b38] fill-current animate-pulse" />
               </div>
